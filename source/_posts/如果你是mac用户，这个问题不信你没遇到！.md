...
在执行命令 `brew update` 命令之后会升级所有管理的模块，比如 `Python` 。因此遇到 `Python` 有版本更新时，嘻嘻，恭喜你中奖了。
...
>
> `find ~/.virtualenvs/my-virtual-env/ -type l` 别闹了好吗？几十个，我怎么弄？放弃放弃，如果你愿意，那么请查看这篇帖子仔细研究即可：https://stackoverflow.com/questions/23233252/broken-references-in-virtualenvs
